...
class MainWindow(QMainWindow):
    ...
    def _configure_page(self):
        ...
        bottom = QHBoxLayout()
        self.region_config = PathField("save", "JSON (*.json)"); self.region_config.setText(WORKSPACE / "config" / "dataset_config.json")
    ...
    def _crop_page(self):
        ...
        self.crop_config = PathField("file", "JSON (*.json)"); self.crop_config.setText(WORKSPACE / "config" / "dataset_config.json")
    ...
    def _mask_page(self):
        ...
        self.mask_config = PathField("save", "JSON (*.json)"); self.mask_config.setText(WORKSPACE / "config" / "mask_config.json")
